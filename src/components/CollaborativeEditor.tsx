...
export default function CollaborativeEditor() {
  ...
  const handleExportGist = () => {
    // Simulate GitHub Gist creation
    const gistUrl = `https://gist.github.com/${Math.random().toString(36).substring(7)}`;
        ...
        <AnimatePresence>
          {activePanel && (
            <motion.div
              ...
              className="w-[450px] bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800 overflow-hidden shadow-medium"
            >
